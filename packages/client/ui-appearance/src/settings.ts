...
export interface AppearanceConfig {
  colors: { light: AppearanceColorSet; dark: AppearanceColorSet }
  contrast: number
  surfaceOpacity: number
  wallpaper: { url: string; scrim: number }
 ...
 */
export function encodeConfig(config: AppearanceConfig): string {
 ...
 */
export function decodeConfig(raw: string): AppearanceConfig {
  try {
